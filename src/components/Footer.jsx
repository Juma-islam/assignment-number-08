...
<footer className="footer sm:footer-horizontal bg-neutral  text-neutral-content p-10">
  ...
  </nav> <hr className=" mt-10 md:mt-20" />

</footer>   
        <hr className="border-2 border-gray-800 px-10  " />
      <p className="bg-black text-white text-center">Copyright © 2025 - All right reserved</p>
